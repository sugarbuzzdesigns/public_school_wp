...
a("#contact .city").waypoint({handler:function(b){a(this.element).removeClass("animate")},offset:"-50%"})}},a(function(){PS.WaypointSetup.init()})}(jQuery);// Homepage Slider for Team Members
