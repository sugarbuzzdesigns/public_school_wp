...
return Waypoint.viewportHeight()-a("#jobs .highlight-text").height()}})},bindInViewWaypoints:function(b){a(this.waypointElements).each(function(b,c){var d=a(c);
