...
var PS=PS||{};!function(a){PS.TeamSlider={init:function(){var b=this;this.$sliderContainer=a(".team-slider"),this.$teamMembers=a(".team-member"),this.$contentNav=a(".content-nav"),this.$contentNavItems=a("li",this.$contentNav),this.sliderOptions={adaptiveHeight:!0,mode:"fade",pager:!1,nextSelector:"#slider-next",prevSelector:"#slider-prev",onSliderLoad:function(){},onSlideBefore:function(){b.setContentHeights(b.getCurrentSlideJquery(b.teamSlider.getCurrentSlide()))}},this.setupSlider(),this.bindEvents()},setupSlider:function(){var a=this;this.teamSlider=this.$sliderContainer.bxSlider(this.sliderOptions),this.$sliderContainer.addClass("loaded"),setTimeout(function(){a.teamSlider.redrawSlider()},100)},bindEvents:function(){var b=this;b.$contentNavItems.on("click",function(){var c=a(this).data("about-navitem");b.setActiveNavitem(a(this)),b.updateCopySlide(c)})},updateCopySlide:function(b){var c=this,d=this.getCurrentSlideJquery(),b='[data-nav-id="'+b+'"]';a(".content",d).css({height:a(b,d).outerHeight()}),a(b,d).siblings().not("nav").hide(),a(b,d).fadeIn(),c.teamSlider.redrawSlider()},setActiveNavitem:function(a){a.addClass("active").siblings().removeClass("active")},setContentHeights:function(a){var b=a;b.find(".content");b.find(".inner").each(function(a,b){})},getCurrentSlideJquery:function(){return this.$teamMembers.eq(this.teamSlider.getCurrentSlide())}},a(function(){PS.TeamSlider.init()})}(jQuery);