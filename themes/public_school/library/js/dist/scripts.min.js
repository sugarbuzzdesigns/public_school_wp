...
var PS=PS||{};!function(a){PS.TeamSlider={init:function(){this.$sliderContainer=a(".team-slider"),this.$teamMembers=a(".team-member"),this.$contentNav=a(".content-nav"),this.$contentNavItems=a("li",this.$contentNav),this.sliderOptions={adaptiveHeight:!0,mode:"fade",pager:!1,nextSelector:"#slider-next",prevSelector:"#slider-prev",onSliderLoad:function(){a("body").trigger("slider-loaded"),Waypoint.viewportWidth()<768&&a(".content-nav").css({position:"absolute",top:a(".team-member-photo").position().top+a(".team-member-photo").height()}),a(".content-nav").css({opacity:1})},onSlideBefore:function(){}},this.setupSlider(),this.bindEvents()},setupSlider:function(){var a=this;this.teamSlider=this.$sliderContainer.bxSlider(this.sliderOptions),this.$sliderContainer.addClass("loaded"),setTimeout(function(){a.teamSlider.redrawSlider()},100)},bindEvents:function(){var b=this;b.$contentNavItems.on("click",function(){var c=a(this).data("about-navitem");b.setActiveNavitem(a(this)),b.updateCopySlide(c)})},updateCopySlide:function(b){var c=this,d=this.getCurrentSlideJquery(),b='[data-nav-id="'+b+'"]';a(".content",d).css({height:a(b,d).outerHeight()}),a(b,d).siblings().not("nav").hide(),a(b,d).fadeIn(),c.teamSlider.redrawSlider()},setActiveNavitem:function(a){a.addClass("active").siblings().removeClass("active")},getCurrentSlideJquery:function(){return this.$teamMembers.eq(this.teamSlider.getCurrentSlide())}},a(function(){PS.TeamSlider.init()})}(jQuery);var PS=PS||{};!function(a){PS.Typer={init:function(){a("#jobs").on("in-view-down",function(){a("#jobs h2 span:first").typed({strings:["are you"],contentType:"text",showCursor:!1,typeSpeed:50,callback:function(){a("#jobs h2 .highlight-text").typed({strings:["always a student?"],contentType:"text",showCursor:!1,typeSpeed:100,callback:function(){a("#jobs h2 em").addClass("highlight")}})}})})}},a(function(){PS.Typer.init()})}(jQuery);